      ...
      >
        <div
          className={clsx(
            ...
            !isDetailsExpanded
              ? "hover:bg-green-bg focus:outline-0 focus:bg-green-bg rounded-3"
              : "rounded-t-3",
          )}
          role="button"
        ...
        >
          <button
            ...
            className="text-14 flex items-center hover:text-green focus:outline-0 focus:text-green gap-1 duration-200"
          >
